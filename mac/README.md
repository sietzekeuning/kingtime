...
| **Client, project, play** | Add an entry: choose a client and a project, add a note if you like, and press "Save and start". Pausing and pressing play again continues the same entry instead of scattering the day over many small ones. |
