...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Only user data: the database dump is added separately and the
                    // code lives in git. storage/ is a shared path across releases.
                    storage_path('app'),
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'info@kingwebsites.nl'),
