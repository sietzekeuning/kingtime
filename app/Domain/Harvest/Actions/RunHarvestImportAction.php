...
class RunHarvestImportAction
{
     ...
     */
    public function handle(?CarbonInterface $updatedSince = null, bool $full = false, ?callable $progress = null): HarvestImport
    {
        ...
        try {
            $since = $full ? null : ($updatedSince ?? HarvestImport::lastSuccessful()?->started_at?->subMinutes(self::INCREMENTAL_OVERLAP_MINUTES));
